...
function PropertiesComponent({ elementInstance }: { elementInstance: FormElementInstance }) {
  ...
  const form = useForm<propertiesFormSchemaType>({
    ...
    defaultValues: {
      ...
      extraLabel: element.extraAttributes.extraLabel,
    },
  });
  ...
  useEffect(() => {
    ...
    const formattedExtraLabel = labelValue.toLowerCase().replace(/\s+/g, '_');
  ...
  function applyChanges(values: propertiesFormSchemaType) {
    const { label, helperText, placeHolder, required, options ,extraLabel} = values;
